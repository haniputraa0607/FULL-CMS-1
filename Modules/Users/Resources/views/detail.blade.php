...
{{--											</div> -->--}}
											<div class="form-group">
												...
												<div class="input-group date date-picker margin-bottom-5" data-date-format="yyyy-mm-dd">
													<input type="text" class="form-control form-filter input-sm date-picker" name="birthday" placeholder="From"  value="@if(!empty($profile['birthday'])){{date('d/m/Y', strtotime($profile['birthday']))}}@endif">
