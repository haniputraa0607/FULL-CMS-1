                            ...
                            <div class="row text-center">
                                ...
                                @else
                                    ...
                                    @if ($data['detail']['pickup_type'] == 'set time')
                                        <div class="col-12 text-21-7px Ubuntu-Medium" style="color: #000000;">{{ date('H:i', strtotime($data['detail']['pickup_time'])) }}</div>
            ...
            <div class="kotak-biasa" style="background-color: #FFFFFF;padding: 15px;margin-top: 10px;">
                ...
                @foreach ($data['product_transaction'] as $key => $item)
                    <div class="row space-text">
                        ...
                        <div class="col-3 text-right Ubuntu-Medium text-black">{{ number_format($item['transaction_product_subtotal'])}}</div>
                    </div>
                    <div class="row space-text">
                        ...
                        <div class="col-3 text-right Ubuntu-Medium text-black" style="color:grey;font-size: 11px">
                            @if($item['transaction_product_qty'] > 1)@ {{ number_format(str_replace("@","",$item['transaction_product_sub_item']))}}@endif
                        </div>
                    </div>
                    <div class="col-12">
            ...
            <div class="kotak-biasa" style="background-color: #FFFFFF;padding: 15px;margin-top: 10px;">
                ...
                @if($data['transaction_discount'] != 0)
                    <div class="row space-bottom">
                        ...
                        <div class="col-6 text-13-3px text-right Ubuntu" style="color: red">{{ number_format($data['transaction_discount']) }}</div>
                    </div>
                @endif
                <div class="row" style="background-color: #f0f3f7;border-radius: 5px;">
                    ...
                    <div class="col-6 text-13-3px text-right Ubuntu-Bold text-black" style="padding-top: 4px;padding-bottom: 4px;"><b>{{ number_format($data['transaction_grandtotal']) }}</b></div>
                </div>
            </div>
            ...
            <div class="kotak-biasa" style="background-color: #FFFFFF;padding: 15px;margin-top: 10px;">
                ...
                <div class="row">
                    @foreach($data['transaction_payment'] as $dp)
                        ...
                        ?>
                        @if($check === false)
                            <div class="col-6 text-13-3px text-right Ubuntu-Medium text-black">{{ number_format($dp['amount'])}}</div>
                        @else
                            <div class="col-6 text-13-3px text-right Ubuntu-Medium" style="color: red">{{ number_format($dp['amount'])}}</div>
                        @endif
                    @endforeach
                </div>
            </div>
