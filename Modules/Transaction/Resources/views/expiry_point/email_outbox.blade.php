		...
		<div class="portlet light bordered">
			<div class="portlet-title">
				<div class="caption font-blue ">
					...
					<span class="caption-subject bold uppercase">Notification Expiry Point Email Outbox List</span>
				</div>
			</div>
							...
							@if(!empty($data))
								@foreach($data as $key => $value)
									<tr>
										...
										<td>{{$value['email_log_subject']}}</td>
										<td><?php echo $value['email_log_message'];?></td>
										<td>
											Name : {{$value['name']}}<br>
