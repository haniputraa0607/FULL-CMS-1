<table class="table table-bordered table-hover">
    ...
    <tbody>
        ...
        <tr id="variant{{$idx}}-container">
            ...
            <td><select class="select2b selector{{$variant['id_product_variant']}}{{$child['id_product_variant']}} selector{{$child['id_product_variant']}}{{$variant['id_product_variant']}}"></select></td>
        </tr>
        @php $idx++ @endphp
        @endforeach
        @endforeach
