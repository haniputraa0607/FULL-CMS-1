                ...
                <form role="form" action="{{ url()->current() }}" method="post">
                    ...
                    <div class="form-body">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <select name="parent" class="select2 form-control" data-placeholder="Select one..." required>
                                        ...
                                        <option value="{{$parent['id_product_variant']}}">{{$parent['product_variant_name']}}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <input type="text" class="form-control" name="product_variant_code" required>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <input type="text" class="form-control" name="product_variant_name" required>
                                </div>
                            </div>
                        </div>
