                    ...
                    <td class="text-center">
                        ...
                        @else
                            @if($val['report_type'] == 'Deals')
                                <a class="btn btn-sm red" href="{{ url('deals/transaction/export-action/deleted', $val['id_export_queue']) }}"><i class="fa fa-trash-o"></i></a>
                                <a class="btn btn-sm blue" href="{{ url('deals/transaction/export-action/download', $val['id_export_queue']) }}"><i class="fa fa-download"></i></a>
                            @endif
                        @endif
                    </td>
                </tr>
